                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/updatePassword') ?>">
                                            ...
                                            <div class="form-group">
                                                <label for="input-1">Current Password <span style="color:red">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="input-1">New Password <span style="color:red">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="input-1">Confirm New Password <span style="color:red">*</span></label>
